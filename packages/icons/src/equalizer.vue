<template>
	<svg width="1em" height="1em" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" stroke-width="4">
		<path d="M11 16V42" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
		<path d="M24 29V42" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
		<path d="M24 19V6" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
		<path d="M37 6V32" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
		<path
