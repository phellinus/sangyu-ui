...
`filled` 是按钮的默认样式类型，特点是**以主题色作为按钮背景色**，并使用清晰明确的前景色（文字颜色）来提升可读性。

当你希望按钮在页面中更醒目、更具操作引导性时，推荐使用 `filled` 类型。

通过设置 `type="filled"` 并搭配 `color` 属性，你可以快速构建出不同语义的主按钮，例如：主操作、成功、警告或危险操作。
