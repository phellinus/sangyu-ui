<docs>
---
    title: 按钮的文字颜色-textColor
---

- sy-button 提供 textColor 属性，用于自定义按钮的文字颜色。
- 所有按钮类型（filled、border、flat、line、gradient、relief 等）都可以使用 textColor，并且与 color（按钮主色）独立。

- 你可以通过 textColor 让按钮文字更具视觉对比、层次感，达到更好的配色效果。
